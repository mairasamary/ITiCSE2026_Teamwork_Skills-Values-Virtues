...
The literature corpus for this SLR is large (~11,000 papers before screening; 555 included as primary studies after screening — see [`systematic-literature-review/primary-studies.md`](./systematic-literature-review/primary-studies.md) for the full list), so **the paper PDFs themselves are not stored in this GitHub repository.** Large source materials and full data exports are archived on **Zenodo** (DOI to be added once the first release is published — see below), and only the tables, scripts, and documentation needed to reproduce the process are versioned here in GitHub.
