...
**[`screening-tool-documentation.md`](./screening-tool-documentation.md)**, in this same folder, is the fuller write-up behind these tables — the master spreadsheet's tab-by-tab structure, the paper-screening web app and its automation pipeline, and the data fixes applied along the way. Start there for the full Phase 1 picture; this README focuses on what each file is and how it maps to the diagram below.
...
For the Phase 2 field definitions and both AI-assisted extraction iterations, see [`../extraction/ai-assisted-extraction.md`](../extraction/ai-assisted-extraction.md). For how the screening tool and its pipeline work, see [`screening-tool-documentation.md`](./screening-tool-documentation.md).
