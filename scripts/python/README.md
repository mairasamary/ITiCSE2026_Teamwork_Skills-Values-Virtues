...
See [`../../docs/methodology/screening-tool-documentation.md`](../../docs/methodology/screening-tool-documentation.md) for the full algorithm description and known bug fixes.
